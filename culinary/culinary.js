    ...
    */
    ...
    var markers = [
        ...
        },
        {
            ...
            content:'<h1>Nuwara Eliya</h1>'
        },
        {
            coords:{lat: 7.3010, lng:80.3872},
            content:'<h1> Pinnawala Elephant Orphanage</h1>'
        },
        {
            coords:{lat: 7.2683, lng:80.5966},
            content:'<h1>Perandeniya Botanical Gardens</h1>'
        },
        {
            coords:{lat: 6.7734, lng:80.8312},
            content:'<h1>Bambarakanda Falls, Ohiya</h1>'
        },
        {
            coords:{lat: 6.8407, lng:81.0542},
            content:'<h1>Ravana Falls</h1>'
        }
    ];
