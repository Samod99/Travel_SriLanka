...
function initMap()
{
    ...
    */
    ...
    var markers = [
        ...
        {
            coords:{lat: 6.2755, lng:81.3582},
            content:'<h1>Yala</h1>'
        },
        {
            coords:{lat: 8.4564, lng:80.0476},
            content:'<h1>Wilpattuwa</h1>'
        },
        {
            coords:{lat: 6.4381, lng:80.8886},
            content:'<h1>Udawalawe</h1>'
        },
        {
            coords:{lat: 8.0330, lng:80.8244},
            content:'<h1>Minneriya</h1>'
        },
        {
            coords:{lat: 6.8467, lng:80.7653},
            content:'<h1>Hortan place</h1>'
        }
    ];
