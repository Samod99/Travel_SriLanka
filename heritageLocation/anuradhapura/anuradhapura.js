...
function initMap()
{
    ...
    */
    ...
    var markers = [
        {
            coords:{lat: 8.3500, lng:80.3964},
            content:'<h1>Ruwanwelisaya</h1>'
        },
        {
            coords:{lat: 8.3513, lng:80.4038},
            content:'<h1>Jetavanaramaya</h1>'
        },
        {
            coords:{lat: 8.3448, lng:80.3972},
            content:'<h1>Jaya Sri Maha Bodhi</h1>'
        },
        {
            coords:{lat: 8.3459, lng:80.3980},
            content:'<h1>Lovamahapaya</h1>'
        },
    ];
