...
function initMap()
{
    ...
    */
    ...
    var markers = [
        ...
        {
            coords:{lat: 7.9661, lng:81.0049},
            content:'<h1>Gal Vihara</h1>'
        },
        {
            coords:{lat: 7.9474, lng:81.0013},
            content:'<h1>polonnaruwa vatadage</h1>'
        },
        {
            coords:{lat: 7.9245, lng:80.9945},
            content:'<h1>Pothgul Viharaya</h1>'
        },
        {
            coords:{lat: 7.9628, lng:81.0036},
            content:'<h1>lankatilaka vihara polonnaruwa</h1>'
        },
    ];
