...
<body>
    ...
    <section class="main" >
        <div class="content">
            <h2>Hello, This is <br><span>kandy</span></h2>
    ...
    <section class="kandy">
        <div class="title reveal">
            <h2 class="section-title">Kandy</h2>
        </div>
