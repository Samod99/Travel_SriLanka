...
function initMap()
{
    ...
    */
    ...
    var markers = [
        ...
        {
            coords:{lat: 7.2956, lng:80.6310},
            content:'<h1>Bahirawakanda Vihara Buddha Statue </h1>'
        },
        {
            coords:{lat: 7.2179, lng:80.5677},
            content:'<h1>Embekka Devalaya</h1>'
        },
        {
            coords:{lat: 7.2340, lng: 80.5649},
            content:'<h1>Lankatilaka Vihara</h1>'
        },
        {
            coords:{lat: 7.2936, lng:80.6413},
            content:'<h1>temple of the tooth</h1>'
        },
    ];
