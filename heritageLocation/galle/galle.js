...
function initMap()
{
    ...
    */
    ...
    var markers = [
        ...
        {
            coords:{lat: 6.0246, lng:80.2194},
            content:'<h1>galle lighthouse</h1>'
        },
        {
            coords:{lat: 6.0300, lng:80.2151},
            content:'<h1>Galle Clock Tower</h1>'
        },
        {
            coords:{lat: 6.0286, lng:80.2172},
            content:'<h1>National Museum of Galle</h1>'
        },
        {
            coords:{lat: 6.0282, lng:80.2171},
            content:'<h1>Groote Kerk, Galle</h1>'
        },
    ];
