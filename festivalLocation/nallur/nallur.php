...
<head>
    ...
    <title>Nallur festival</title>
    <link rel="stylesheet" href="nallur.css">
...
<body>
    ...
    <section class="main" >
        <div class="content">
            <h2>Hello, This is <br><span>Nallur Festival</span></h2>
    ...
    <section class="nallur">
        <div class="title reveal">
            <h2 class="section-title">Nallur Festival</h2>
        </div>
            ...
            <div class="column col-left reveal">
             <div class="img-card">
                ...
                <div class="column col-right reveal">
                    ...
                    <div class="place-box">
                        <h2>Places</h2>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsum cumque nesciunt illum, laborum eum maiores eveniet a pariatur sapiente ipsam amet esse voluptatibus voluptate quaerat aspernatur soluta numquam aut itaque.</p>
