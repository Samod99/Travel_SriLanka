    ...
    var markers = [
        {
            ...
            content:'<h1>Temple Of The Tooth Relic Kandy</h1>'
        },
        {
            coords:{lat: 6.4185, lng:81.3333},
            content:'<h1>Ruhunu Maha Kataragama Develaya</h1>'
        },
        {
            coords:{lat: 6.6905, lng:80.3799},
            content:'<h1>Rathnapura Saman devalaya</h1>'
        },
        {
            coords:{lat: 8.8564, lng:80.2042},
            content:'<h1>Madu church</h1>'
        },
        {
            coords:{lat: 5.9320, lng:80.5911},
            content:'<h1>Dondara</h1>'
        },
        {
            coords:{lat: 9.6745, lng:80.0294},
            content:'<h1>Nallur jaffna</h1>'
        }
    ];
