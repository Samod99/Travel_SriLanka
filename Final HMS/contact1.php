...
<body>
    ...
    <div class="bradcam_area breadcam_bg_2">
        <h3>Wish to know more about our Unawatuna luxury hotel? Or perhaps you have questions about the facilities we provide? Whatever your questions might be we are delighted to enlighten you! Fill out the form below and we will get in touch with you soon. You could also reach out to us directly through any of the below means!</h3>
    </div>
    <!-- bradcam_area_end -->
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3> No.8/B,Main street,Hambantota.</h3>
                                <p> Sri Lanka</p>
                            </div>
                        </div>
                        <div class="media contact-info">
