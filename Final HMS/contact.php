                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="http://localhost/1st%20year%20final%20project/">Travel</a></li>
...
<input type="text" class="form-control mb-2" placeholder="Telephone No" name="tno">
<input type="text" class="form-control mb-2" placeholder="message" name="message">
