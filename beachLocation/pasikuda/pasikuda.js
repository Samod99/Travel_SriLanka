...
function initMap()
{
    ...
    */
    ...
    var markers = [
        {
            coords:{lat: 7.9300, lng:81.5612},
            content:'<h1>Pasikuda Beach</h1>'
        },
        {
            coords:{lat: 7.9375, lng:81.5629},
            content:'<h1>Pasikuda Carols Island</h1>'
        },
        {
            coords:{lat: 7.9173, lng: 81.5677},
            content:'<h1>Kalkudah Beach </h1>'
        },
