...
function initMap()
{
    ...
    */
    ...
    var markers = [
        {
            coords:{lat: 6.1219, lng:80.1120},
            content:'<h1>Narigama Beach</h1>'
        },
        {
            coords:{lat: 6.1377, lng:80.0991},
            content:'<h1>Hikkaduwa Beach</h1>'
        },
        {
            coords:{lat: 6.1414, lng:80.0994},
            content:'<h1>Hikkaduwa Harbour Complex</h1>'
        },
    ];
