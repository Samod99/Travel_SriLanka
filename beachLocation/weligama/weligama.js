...
function initMap()
{
    ...
    */
    ...
    var markers = [
        {
            coords:{lat: 5.9574, lng:80.4143},
            content:'<h1>Secret Jungle Beach</h1>'
        },
        {
            coords:{lat: 5.9712, lng:80.4270},
            content:'<h1>Soul Defender Surf camp</h1>'
        },
        {
            coords:{lat: 5.9583, lng: 80.4083},
            content:'<h1>Abimanagama Beach</h1>'
        },
        {
            coords:{lat: 5.9647, lng: 80.3909},
            content:'<h1>Midigama Beach</h1>'
        },
        {
            coords:{lat: 5.9647, lng: 80.3909},
            content:'<h1>Midigama Beach</h1>'
