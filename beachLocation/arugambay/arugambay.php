...
<head>
    ...
    <title>Arugam bay Beach details</title>
    <link rel="stylesheet" href="arugambay.css">
...
<body>
    ...
    <section class="main" >
        <div class="content">
            <h2>Hello, This is <br><span>Arugam Bay </span></h2>
    ...
    <section class="arugambay">
        <div class="title reveal">
            <h2 class="section-title">Arugam Bay</h2>
        </div>
...
<!--arugam bay end-->
 ...
 <footer class="footer">
    ...
    <script src="arugambay.js"></script>
</body>
</html>