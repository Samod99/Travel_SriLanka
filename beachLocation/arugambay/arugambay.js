...
function initMap()
{
    ...
    */
    ...
    var markers = [
        {
            coords:{lat: 6.8340, lng:81.8379},
            content:'<h1>Pasarichenai Beach</h1>'
        },
        {
            coords:{lat: 6.8404, lng:81.8368},
            content:'<h1>Arugam Bay Beach</h1>'
        },
        {
            coords:{lat: 6.8350, lng:81.8319},
            content:'<h1>Karma Gardens</h1>'
        },
    ];
