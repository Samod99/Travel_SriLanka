...
function initMap()
{
    ...
    */
    ...
    var markers = [
        {
            coords:{lat: 5.9437, lng:80.4499},
            content:'<h1>Secret Beach Mirissa</h1>'
        },
        {
            coords:{lat: 5.9447, lng:80.4592},
            content:'<h1>Mirissa Beach</h1>'
        },
        {
            coords:{lat: 5.9392, lng:80.4682},
            content:'<h1>coconut tree hill </h1>'
        },
    ];
