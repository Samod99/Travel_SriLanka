...
function initMap()
{
    ...
    */
    ...
    var markers = [
        {
            coords:{lat: 6.0008, lng:80.2609},
            content:'<h1>Playa mágica</h1>'
        },
        {
            coords:{lat: 6.0187, lng:80.2394},
            content:'<h1>Jungle Beach</h1>'
        },
        {
            coords:{lat: 5.9996, lng:80.2637},
            content:'<h1>dalawella beach</h1>'
        },
        {
            coords:{lat: 5.9979, lng:80.2701},
            content:'<h1>Mihiripenna Beach</h1>'
        },
        {
            coords:{lat: 6.0097, lng:80.2484},
            content:'<h1>Unawatuna Beach</h1>'
        },
    ];
