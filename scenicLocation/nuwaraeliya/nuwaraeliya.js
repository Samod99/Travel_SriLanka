...
function initMap()
{
    ...
    */
    ...
    var markers = [
        {
            coords:{lat: 6.9784, lng: 80.7724},
            content:'<h1>Piduruthalagala Mountain Entrance</h1>'
        },
        {
            coords:{lat: 6.9663, lng:80.7779},
            content:'<h1>Galways Land National Park</h1>'
        },
        
        {
            coords:{lat: 6.9691, lng:80.7682},
            content:'<h1>victoria park,</h1>'
        },
        
        {
            coords:{lat: 6.9567, lng: 80.7783},
            content:'<h1>Lake Gregory </h1>'
        },
        {
            coords:{lat: 6.7927, lng: 80.7895},
            content:'<h1>Bakers Fall</h1>'
        },
