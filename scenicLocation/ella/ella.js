...
function initMap()
{
    ...
    */
    ...
    var markers = [
        ...
        {
            coords:{lat: 6.8768, lng:81.0608},
            content:'<h1>nine arch bridge</h1>'
        },
        {
            coords:{lat: 6.8727, lng: 81.0519},
            content:'<h1>Ella Rock</h1>'
        },
        {
            coords:{lat: 6.8633, lng: 81.0650},
            content:'<h1>Little Adams Peak</h1>'
        },
        {
            coords:{lat: 6.8645, lng: 81.0486},
            content:'<h1>Ravana Cave</h1>'
        },
        {
            coords:{lat: 6.8407, lng: 81.0542},
            content:'<h1>Ravana Ella/h1>'
        },
        {
            coords:{lat: 6.7331, lng: 81.0314},
            content:'<h1>Diyaluma Falls</h1>'
        },
