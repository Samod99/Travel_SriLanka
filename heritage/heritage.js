    ...
    var markers = [
        {
            ...
            content:'<h1>Anuradhapura</h1>'
        },
        {
            coords:{lat: 7.9403, lng: 81.0188},
            content:'<h1>Polonnaruva</h1>'
        },
        {
            coords:{lat: 7.9573, lng:80.7600},
            content:'<h1>Sigiriya</h1>'
        },
        {
            coords:{lat: 7.8179, lng:80.3116},
            content:'<h1>Yapahuwa</h1>'
        },
        {
